...
function executeCommand() {
    ...
    for (var _i = 0, commands_1 = commands; _i < commands_1.length; _i++) {
        ...
        outputElement.innerHTML += "<div class=\"command-prompt\">".concat(user_prompt, " ").concat(command.command, "</div>");
...
function processCommand(command) {
    ...
    return "Command not found: ".concat(command);
}
function cyclePreviousCommand() {
    var inputElement = terminalElement === null || terminalElement === void 0 ? void 0 : terminalElement.querySelector("input");
